...
const categoryMeta = [
  ...
  {label: 'Narrative & Storytelling', handle: 'narrative-and-storytelling-art', description: 'Narrative-driven artworks that tell stories of culture and community.'},
...
export const meta = ({data}: any) => [
  ...
  {name: 'description', content: data?.category?.description || 'Browse curated African art prints from Kumachi Prints.'},
];
        ...
        <div className="container-gallery grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-14 items-center py-12 lg:py-16">
          ...
          >
            ...
            <div className="absolute -bottom-5 left-5 right-5 p-4" style={{backgroundColor: 'var(--color-surface-deep)', color: 'var(--color-bg-primary)'}}>
              <p className="text-caption uppercase" style={{color: 'var(--color-accent-ochre)'}}>Category guide</p>
...
export function ErrorBoundary() {
  ...
  if (isRouteErrorResponse(error) && error.status === 404) {
    return <main className="container-gallery section-pad"><h1 className="text-h1">Collection not found</h1><a href="/collection" className="text-gold">View all prints</a></main>;
  }
