...
const columns = [
  ...
  {icon: Globe, stat: 'Worldwide', sub: 'Ships through Printful'},
  {icon: Sparkles, stat: 'Open + Limited', sub: 'Two edition paths'},
  ...
  return (
    <section className="border-y border-gold/20 bg-surface py-8">
      <div className="container-gallery">
        <motion.div className="grid grid-cols-2 gap-8 md:grid-cols-4" initial="hidden" whileInView="show" viewport={{once: true, margin: '-40px'}} transition={{staggerChildren: 0.06}}>
          {columns.map((col) => (
